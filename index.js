...
const routeLoggerMiddleware = require('./middlewares/routerLogger');
...
app.all('*', function(req, res, next) {
    ...
    res.header('Access-Control-Allow-Headers', 'Authorization, Origin, X-Requested-With, Content-Type, Accept,auth');
    res.header('Access-Control-Allow-Methods', 'GET,PUT,POST,DELETE')
    res.header('Access-Control-Request-Headers','auth')
    next();
});
// var corsOption={
...
app.get("/", function(req, res) {
  req.session.authToken = "Nic Raboy";
});
